...
1. แก้บั๊ก Risk Summary gauge: needle ชี้ผิดทิศ (คะแนนสูง/ปลอดภัย เคยชี้ไปโซนแดง) — กลับด้านสูตรมุมเข็มแล้ว
2. เพิ่มคอลัมน์ "TRADING LIQUIDITY" ในแถวกราฟหลัก (ต้องคำนวณคะแนนใหม่ก่อนถึงจะเทียบกับหุ้นอื่นได้)
3. การ์ด "DOWNSIDE RISK" โชว์ VaR คู่กับ CVaR แทนที่จะโชว์ VaR อย่างเดียว
4. แก้คำอธิบาย Sharpe/Sortino ให้ตรงกับความจริงว่าหัก Risk-free Rate แล้ว
5. ตาราง Stress Test ตัด "Volatility Shock" กับ "Recession Scenario" (สูตรประดิษฐ์เอง ไม่มีที่มา)
